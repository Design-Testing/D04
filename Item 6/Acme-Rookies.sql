...
CREATE TABLE `application` (
  ...
  PRIMARY KEY (`id`),
  KEY `UK_j5q7tufhnmp03pdri8bffbr7` (`rooky`),
  KEY `UK_cqpb54jon3yjef814oj6g6o4n` (`position`),
  KEY `UK_jpowpw8bl91e0nlnt7fxg0kcg` (`rooky`,`status`),
  KEY `UK_7gn6fojv7rim6rxyglc6n9mt2` (`problem`),
...
CREATE TABLE `audit` (
  ...
  `position` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `UK_3m6p53wfvy7kcl4f4fvphkh9h` (`auditor`),
  KEY `UK_129q16g73thvwjndimtkl04fw` (`auditor`,`is_draft`),
  KEY `UK_kysp2retahkwj2q0lqa49gwlo` (`position`,`is_draft`),
...
INSERT INTO `audit` VALUES (1278,0,'','2019-03-16 15:20:00',6,'Text audit 1',1233,1235),(1279,0,'','2019-04-23 16:30:00',8,'Text audit 2',1233,1235),(1280,0,'','2019-03-16 15:20:00',7,'Text audit 3',1232,1238),(1281,0,'','2019-04-23 16:30:00',3,'Text audit 4',1232,1238),(1282,0,'','2019-03-16 15:20:00',4,'Text audit 5',1233,1240),(1283,0,'','2019-04-23 16:30:00',8,'Text audit 6',1233,1240),(1284,0,'\0','2019-04-23 16:30:00',8,'Text audit 7',1233,1240);
...
CREATE TABLE `auditor` (
  ...
  KEY `auditorUK_k77r9upyn4vc6rupdcqapbko5` (`spammer`),
...
CREATE TABLE `company` (
  ...
  KEY `companyUK_k77r9upyn4vc6rupdcqapbko5` (`spammer`),
...
CREATE TABLE `curricula` (
  ...
  KEY `UK_pj0qgw6mawhkummu8br1hy3xy` (`rooky`),
...
CREATE TABLE `folder` (
  ...
  PRIMARY KEY (`id`),
  KEY `UK_7so67r3ugkl1f9y9tv1aynnrx` (`actor`,`name`),
  KEY `UK_13reojwl2ypyecuvvsopd48lq` (`father`),
...
CREATE TABLE `item` (
  ...
  PRIMARY KEY (`id`),
  KEY `UK_isojc9iaj7goju6s26847atbn` (`provider`),
...
CREATE TABLE `position` (
  ...
  KEY `UK_pgbuujh9ulwd22ubhgnty4bmo` (`mode`),
...
INSERT INTO `position` VALUES (1235,0,'2020-04-24 00:00:00','Description position 1','FINAL','Profile for position 1',1500,'COMM-1234','Position 1',1230),(1236,0,'2020-05-24 00:00:00','Description position 2','DRAFT','Profile for position 2',1700,'COMM-1235','Position 2',1231),(1237,0,'2020-04-24 00:00:00','Description position 3','DRAFT','Profile for position 3',1750,'COMM-1236','Position 3',1230),(1238,0,'2020-04-24 00:00:00','Description position 4','FINAL','Profile for position 4',2000,'COMM-1237','Position 4',1230),(1239,0,'2020-04-24 00:00:00','Description position 5','DRAFT','Profile for position 5',1750,'COMM-1238','Position 5',1230),(1240,0,'2020-04-24 00:00:00','Description position 6','FINAL','Profile for position 6',1750,'COMM-1789','Position 6',1230),(1241,0,'2020-04-24 00:00:00','Description position 7','DRAFT','Profile for position 7',1750,'COMM-1784','Position 7',1231),(1242,0,'2020-04-24 00:00:00','Description position 8','DRAFT','Profile for position 8',1750,'COMM-1783','Position 8',1231),(1243,0,'2020-04-24 00:00:00','Description position 9','DRAFT','Profile for position 9',1750,'COMM-1782','Position 9',1231),(1244,0,'2020-04-24 00:00:00','Description position 10','DRAFT','Profile for position 10',1750,'COMM-1781','Position 10',1231);
...
INSERT INTO `problem_attachments` VALUES (1245,'http://www.attachment1Problem1.com'),(1245,'http://www.attachment2Problem1.com'),(1246,'http://www.attachment1Problem2.com'),(1248,'http://www.attachment1Problem4.com'),(1249,'http://www.attachment1Problem5.com'),(1250,'http://www.attachment1Problem6.com'),(1251,'http://www.attachment1Problem7.com');
...
CREATE TABLE `provider` (
  ...
  KEY `providerUK_k77r9upyn4vc6rupdcqapbko5` (`spammer`),
...
CREATE TABLE `rooky` (
  ...
  KEY `rookyUK_k77r9upyn4vc6rupdcqapbko5` (`spammer`),
...
CREATE TABLE `sponsorship` (
  ...
  KEY `UK_dwk5ymekhnr143u957f7gtns6` (`provider`),
  KEY `UK_jnrjojfnyyaie1n4jhsdxjbig` (`position`),
...
-- Dump completed on 2019-07-15 10:48:47
